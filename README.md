...
***nested-heatmap.Rmd:** Ever wanted to make a pretty heatmap with 2 groups (e.g. Category, Subcategory)? Then fret no more! This is the script for you. Allows for clustering and color customization. Additional information on how to calculate z-scores for your own data with R can be found under https://github.com/JFinck1994/Finck_2026_TropMiComUnderDrought/blob/main/scripts/supp_Fig-S4.Rmd
