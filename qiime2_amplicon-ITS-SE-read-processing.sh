## This script is run on the linux terminal and used for AMPLICON ITS SINGLE-END SEQs
...
## - prereq folder: metadata.tsv, samples.txt, manifest_single.csv
## - classifier folder (eg. UNITE10-release) (check other scripts f/ how to train classifier)
...
## - manifest_single.csv: a listing of your samples w/ their locations and full name
## - row 1: sample-id  absolute-filepath  direction
## - row 2-n: sam1  (/PATH/TO/FILE/sam_full_file_name eg. sam1_01_L001_R1_001.fastq.gz)  forward
...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
## Import data 
## - Format 'SingleEndFastqManifestPhred33V2' requires single end (R1) reads
## - eg. sam1_07_L001_R1_001.fastq.gz 

qiime tools import   \
--type 'SampleData[SequencesWithQuality]'\
--input-path prereq/manifest_single.csv \
--input-format SingleEndFastqManifestPhred33V2\
--output-path analysis/seqs/combined_demux.qza

## Pre-requisites: Trimming, Denoising (DADA2 workflow within qiime2) 
## - check your <FORW-PRIMER-SEQ>
